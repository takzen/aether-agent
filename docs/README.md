...
3.  **[Przewodnik Terminala](COMMANDS.md)** — Lista i opis komend (Slash Commands) dostępnych w Dashboardzie.
4.  **[API Reference](API.md)** — Dokumentacja techniczna endpointów FastAPI.

...
### `/logclear`
Trwale usuwa całą historię telemetrii z systemowej bazy danych.
- **Zastosowanie:** Rozwiązanie problemu "Duplicate Keys" po wielu dniach pracy, odświeżenie bazy logs.

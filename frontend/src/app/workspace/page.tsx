                ...
                >
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="min-w-0 pr-16 text-left">
                      <h3 className="text-[13px] font-bold text-neutral-200 mb-1 line-clamp-2 break-all group-hover:text-white transition-colors tracking-tight" title={item.title}>
                        {item.title}
                      </h3>

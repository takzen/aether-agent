...
async def _run_gemini_generate(
    model_id: str,
    user_prompt: str,
    temperature: float,
    images: list[str] | None = None,
) -> str:
    """Direct Gemini multimodal generation."""
    from google import genai
    from google.genai import types

    api_key = os.getenv("GEMINI_API_KEY") or os.getenv("GOOGLE_API_KEY")
    if not api_key:
        raise ValueError("Gemini vision requires GEMINI_API_KEY or GOOGLE_API_KEY.")
    ...
    return answer or "No response generated by Gemini vision model."
    ...
    try:
        ...
        for page_obj in rendered_pages:
            ...
            if vision_model.startswith("ollama:"):
                ...
                page_answer = await _run_gemini_generate(
                    model_id=vision_model,
                    user_prompt=prompt,
                    temperature=0.1,
                    images=[image_b64],
